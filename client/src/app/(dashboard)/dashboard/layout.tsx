...
import { Providers } from "~/components/providers"; //to wrap the entire app with the auth provider, so we can use it in any component without having to import it again
...
export const metadata : Metadata={
    ...
    description: "A powerful AI voice generator built with Next.js, React, and TypeScript.",
